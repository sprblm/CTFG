...
.sidebar li .subtag{list-style:none;margin:0;padding:0;padding-left:1rem;padding-right:1rem;}
.sidebar .nav-link{
    font-size: 15px;
    font-weight:500;
...
.sidebar .tag-open{color: #f91942}
.sidebar .tag-open svg{margin: 0 !important; transform: rotate(90deg)}
.sidebar .has-subtag.active {color: #fff !important;border-radius: 25px;background-color: #f91942;}
