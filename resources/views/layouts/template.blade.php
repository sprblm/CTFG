                    ...
                    <div class="right-side">
                        <div class="header-widget">
                            ...
                            <div style="padding-right: 25px; margin-top: 10px;">
                                ...
                                <a href="/projects/add"  class="@if(@$menu == 'add-project') active @endif" style="padding: 20px 0 0 0 !important; margin-bottom: -5px !important; line-height: 26px !important; color: #EA0630;" class=" with-icon">Add Project <i class="sl sl-icon-plus"></i></a>
                            </div>
                        </div>
                    </div>
